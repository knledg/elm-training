...
For this small tutorial we are going to use Elm's online editor and compiler before we move into building a local project. Navigate to: [Elm Online Editor](elm-lang.org/try). We are gong to build a very, very simple todo list here.
